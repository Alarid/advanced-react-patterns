...
When a context consumer needs to make subsequent calls of dispatch (from
context's reducer), for example when handling async calls and updating the UI,
the "Context Module Functions" pattern consist in relocating those calls in a
function managed by the context module. This can help reducing duplications,
improving performance and avoiding mistakes in dependency lists.
...
Fill out
[the feedback form](https://ws.kcd.im/?ws=Advanced%20React%20Patterns%20%F0%9F%A4%AF&e=01%3A%20Context%20Module%20Functions&em=yoh.legrand%40gmail.com).
